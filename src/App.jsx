            ...
            <div>
              ...
              <div className="md:hidden mt-4">
                ...
                {vistaAgendaMovil === 'dia' && (() => {
                  ...
                  const citas = propias.filter((o) => o.fecha === diaAgendaSel && o.estado !== 'cancelada' && o.estado !== 'por_validar').sort((a, b) => (a.hora || '99').localeCompare(b.hora || '99'));
                      ...
                      {!agendaEdit ? (
                        <div>
                          ...
                          <div style={{ marginTop: 12 }}>
                            ...
                            {!esSoloLectura(sesion.rol, 'ordenes') && (
